							...
							<tr align="center">
								<td colspan=5 style="border: none; margin-top: 30px;">
									...
									<ul class="pagination justify-content-center" >
										...
										<li class="page-item"><a class="page-link" href="MemberAllQnAInfo.do?pageNum=${pageDTO.startPage - 1 }&amount=${pageDTO.amount }" style='text-decoration: none; color: black;'>
												<span aria-hidden="true">&laquo;</span> </a></li>
										</c:if>
									<c:forEach var="num" begin="${pageDTO.startPage }" end="${pageDTO.endPage }">
									<li class="page-item ">
									<a class="page-link ${pageDTO.pageNum eq num? 'bg-success' : 'text-dark' }" href="MemberAllQnAInfo.do?pageNum=${num }&amount=${pageDTO.amount }" style='text-decoration: none; color: white; '>
												<c:out value="${num }"/>
												</a>
									</li>
									</c:forEach>
									<c:if test="${pageDTO.next }">
									<li class="page-item"><a class="page-link" href="MemberAllQnAInfo.do?pageNum=${pageDTO.endPage + 1 }&amount=${pageDTO.amount }" style='text-decoration: none; color: black;'>
...
<form id="AdminMemberQnA" method="get">
 ...
 <script type="text/javascript">
	$(".search_area button").on("click", function(e){
        ...
        AdminMemberQnA.find("input[name='keyword']").val(val);
        AdminMemberQnA.find("input[name='pageNum']").val(1);
        AdminMemberQnA.submit();
    });
	</script>
